                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Row(
                            children: [   GestureDetector( onTap: ()=>navigateToCommunity(context ),
                              child: CircleAvatar(backgroundImage:NetworkImage(post.communityProfilePic,),
                              radius: 16,),
                            ),
                            ...
                            child:  Column(
                              ...
                              children: [
                                ...
                                GestureDetector(onTap: ()=>navigateToUser(context),
                      ...
                      IconButton(onPressed: ()=>deletePost(ref,context), icon:Icon(Icons.delete,
