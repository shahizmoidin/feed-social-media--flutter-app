...
void save(Community community ){
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(backgroundColor: currentTheme.backgroundColor,appBar: AppBar(   title: const Text('Edit Community '),
    centerTitle: false,
    actions: [
            ...
            children: [
              ...
              Positioned(bottom: 20,left: 20,
                child: GestureDetector(onTap: selectProfileImage,
                  ...
                  radius: 32,):CircleAvatar(backgroundImage: NetworkImage(community.avatar),
                  radius: 32,),
                ),
              )
            ],
